const { ShapeValidationError } = require("../constants/errors");

const Shapes = Object.freeze({
  EventService: ["on", "emit", "addListener", "removeListener"],
  AppService: [
    "start",
    "shutdown",
    "scanForNewApps",
  ...
  AppHttpClient: ["get", "post"],
  ModuleDescriptor: ["getType", "getKey", "getName", "getCache", "getRoles"],
  ModuleLoader: [
  ...
  Module: ["getKey", "getType", "enable", "disable"],
  LifecycleEventsStrategy: ["setup", "teardown"],
  AppStore: ["set", "get", "delete"],
  WebService: ["start", "shutdown"]
});

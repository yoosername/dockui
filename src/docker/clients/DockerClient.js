...
DockerClient.prototype.isDockerRunning = function(){
  ...
  console.warn("Not Implemented: You should provide a concrete impementation of DockerClient.isDockerRunning()");
};

DockerClient.prototype.listRunningContainers = function(){
  "use strict";

  console.warn("Not Implemented: You should provide a concrete impementation of DockerClient.listRunningContainers()")
};

...
describe("GitAppLoader", function() {
  ...
  beforeEach(function() {
    ...
    nodeGitSuccessfulStub = new sinon.stub().returns({
      Clone: function(url) {
        nodeGitRepoURLRequested = url;
        return Promise.resolve(url);
      }
    })();
    nodeGitFailureStub = new sinon.stub().returns({
      Clone: function() {
        nodeGitRepoURLRequested = null;
  ...
  it("should detect GIT_APP_LOAD_REQUEST events after scanForNewApps run", function() {
    ...
    var gitAppLoader = new GitAppLoader(
      mockAppStore,
      mockModuleLoaders,
      frameworkEvents
    );
    ...
    gitAppLoader = new GitFailingAppLoader(
      mockAppStore,
      mockModuleLoaders,
      frameworkEvents
    );
